...
[ -f "$HOME/.shell/zsh/alias/lib/programming.zsh" ]  && source $HOME/.shell/zsh/alias/lib/programming.zsh
[ -f "$HOME/.shell/zsh/alias/lib/system.zsh" ]       && source $HOME/.shell/zsh/alias/lib/system.zsh
